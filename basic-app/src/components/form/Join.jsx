                    ...
                    <form onSubmit={handleJoinSubmit}>
                        <ul>
                            <li>
                                ...
                                { form.id === "" && <span id="idMsg">아이디를 입력 해 주세요.</span>}
                                <div>
                                    <input type="text" name="id" id="id" value={form.id} ref={idRef} onChange={handleFormChange}
                                            placeholder="아이디 입력(6~20자)"></input>
                                    <button>중복확인</button>       
                                </div>
                            </li>
                            <li>
                                ...
                                <div>
                                    <input type="password" name="pwd" id="pwd" value={form.pwd} ref={pwdRef} onChange={handleFormChange}
                                            placeholder="비밀번호 입력(문자,숫자,특수문자 포함 6~12자)"></input>
                                </div>
                            </li>
                            <li>
                                ...
                                <div>
                                    <input type="password" name="cpwd" id="cpwd" value={form.cpwd} ref={cpwdRef} onChange={handleFormChange}
                                            placeholder="비밀번호 재입력"></input>
                                </div>
                            </li>
                            <li>
                                ...
                                <div>
                                    <input type="text" name="name" id="name" value={form.name} ref={nameRef} onChange={handleFormChange}
                            ...
                            <li>
                                ...
                                <div>
                                    <input type="text" name="phone" id="phone" value={form.phone} ref={phoneRef} onChange={handleFormChange}
                                            placeholder="휴대폰 번호 입력('-' 포함)"></input>
                                </div>
                            </li>
                            <li>
